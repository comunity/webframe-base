declare module 'webframe-base' {
    ...
    export class ConsoleLogger implements Logger {
	    ...
	    constructor();
	    public id(): string;
	    public log(type: string, requestId: string, start: number[], method: string, url: string, statusCode: number, user?: string, reqHeaders?: any, err?: any, reqBody?: any, resBody?: any, resHeaders?: any): string;
    }
    ...
    export interface Logger {
	    log(type: string, requestId: string, start: number[], method: string, url: string, statusCode: number, user?: string, reqHeaders?: any, err?: any, reqBody?: any, resBody?: any, resHeaders?: any): string;
	    id(): string;
    }
